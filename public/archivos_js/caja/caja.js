...
$(document).ready(function () {
    $("#li_config_pagos_recibo").addClass('active');
    $("#menu_caja").addClass('open');
    $("#menu_caja").css({ 'background-color' : '#9930B0', 'border-radius' : '20px' });

    jQuery("#table_Caja").jqGrid({
        url: 'getRecibosEmititos',
        datatype: 'json', mtype: 'GET',
        height: 'auto', autowidth: true,
        toolbarfilter: true,
        colNames: ['Nº Recibo', 'Persona', 'Concepto', 'Total', 'Tipo', 'Paquete', 'Estado'],
        rowNum: 10, sortname: 'numero_recibo', sortorder: 'desc', viewrecords: true, caption: 'LISTA DE RECIBOS EMITIDOS', align: "center",
        colModel: [
            {name: 'numero_recibo', index: 'numero_recibo', width: 20, align:'center'},
