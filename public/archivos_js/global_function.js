...
function mostraralertasvalidacion(texto, foco)
{
...
function MensajeExito(tit,cont,from,align,type)
{
    $.notify({
        icon: "notifications",
        message: "<b>"+tit+"</b> - "+cont+" "
...
function MensajeAlerta(tit,cont,from,align,type)
{
    $.notify({
        icon: "notifications",
        message: "<b>"+tit+"</b> - "+cont+" "
...
function sin_permiso()
{
    $.notify({
        icon: "notifications",
        message: "<b>Mensaje de Sistema</b> - No Tienes Permiso para Usar esta Opcion "
